...
public class Layouts {
    ...
    public JPanel stepOneLayout() {
        ...
        JLabel toyCodeInputLabel = new JLabel("Insert Your Student Number");
        ...
        JLabel toyNameInputLabel = new JLabel("Insert Your Student Name");
    ...
    public JPanel stepTwoLayout() {
        ...
        JLabel descriptionLabel = new JLabel("Insert Your First Name");
        ...
        JLabel priceLabel = new JLabel("Insert Your Last Name");
        ...
        JLabel dateOfManufactureLabel = new JLabel("Insert Your Last Name");
        ...
        JLabel batchNumberLabel = new JLabel("Insert your Student Faculty");
    ...
    public JPanel stepThreeLayout() {
        ...
        JLabel toyCompanyNameLabel = new JLabel("Enter Your Institutions Name");
        ...
        JLabel streetAddressLabel = new JLabel("Enter Your Institutions Branch");
        ...
        JLabel zipCodeLabel = new JLabel("Enter Your Current Year");
        ...
        JLabel countryLabel = new JLabel("Enter Your Current Semester");
